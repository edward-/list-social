...
export default function NavbarContent({ user, locale, messages, action }: Props) {
        ...
        <div className='h-16 flex items-center justify-between'>
          <div className='flex items-center mx-2'>
            <div className='relative mx-1 lg:hidden'>
              ...
              {appMenuOpen && (
                <Menu ref={appMenuRef} aria-labelledby='app-menu-button' align='rigth'>
                  <MenuItem href={`/${locale}/home`}>
                    <FormattedMessage id='common.navigation.home' />
                  </MenuItem>
                  <MenuItem href={`/${locale}/community`}>
          ...
          <div className='flex items-center mx-2'>
            <div className='relative mx-1'>@{user.nickname}</div>
            ...
            <div className='relative mx-1'>
              ...
              >
                <Image src={user.picture} alt='Profile image' className='rounded-full' width={24} height={24} />
              </button>

              {userMenuOpen && (
                <Menu ref={userMenuRef} aria-labelledby='user-menu-button'>
                  <MenuItem href={`/${locale}/settings`}>
                    <FormattedMessage id='common.user-menu.settings' />
                  </MenuItem>
                  <MenuItem href='#' action={action}>
...
function MenuItem({ href, active, children, action }: MenuItemProps) {
  return (
    <Link
      href={href}
      onClick={action}
